...
from classroom.views import batchCategories, Categories, CategoryCourses, NewCourse, Enroll, DeleteCourse, EditCourse, MyCourses, CourseDetail, Submissions, StudentSubmissions, GradeSubmission
...
urlpatterns = [
	...
	path('batchcategories/', batchCategories , name='batchcategories'),
	path('batchcategories/<int:id>/', Categories , name='categories'),
